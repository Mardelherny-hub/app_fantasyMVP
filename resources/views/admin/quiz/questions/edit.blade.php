<x-admin-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <form action="{{ route('admin.quiz.questions.update', $question->id) }}" method="POST">
                @csrf
                @method('PUT')
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <select name="difficulty" 
                                    ...
                                    <option value="1" {{ old('difficulty', $question->difficulty) == 1 ? 'selected' : '' }}>{{ __('Easy') }}</option>
                                    <option value="2" {{ old('difficulty', $question->difficulty) == 2 ? 'selected' : '' }}>{{ __('Medium') }}</option>
                                    <option value="3" {{ old('difficulty', $question->difficulty) == 3 ? 'selected' : '' }}>{{ __('Hard') }}</option>
                                </select>
                                @error('difficulty')
                                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                                @enderror
                    ...
                    <div class="p-6 text-gray-900">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="translations[es]" 
                                      ...
                                      class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 @error('translations.es') border-red-500 @enderror">{{ old('translations.es', $questionTranslations->get('es')->text ?? '') }}</textarea>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="translations[en]" 
                                      ...
                                      class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 @error('translations.en') border-red-500 @enderror">{{ old('translations.en', $questionTranslations->get('en')->text ?? '') }}</textarea>
                        ...
                        <div>
                            ...
                            <textarea name="translations[fr]" 
                                      ...
                                      class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 @error('translations.fr') border-red-500 @enderror">{{ old('translations.fr', $questionTranslations->get('fr')->text ?? '') }}</textarea>
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-6">
                    <div class="p-6 text-gray-900">
                        ...
                        @php
                            $existingOptions = $question->options()->with('translations')->orderBy('order')->get();
                        @endphp

                        @for($i = 0; $i < 4; $i++)
                            @php
                                $existingOption = $existingOptions->get($i);
                                $optionTranslations = $existingOption ? $existingOption->translations->keyBy('locale') : collect();
                            @endphp
                                ...
                                <div class="flex items-center justify-between mb-3">
                                    ...
                                    <label class="flex items-center">
                                        <input type="radio" 
                                               ...
                                               value="1"
                                               {{ old("options.{$i}.is_correct", $existingOption?->is_correct ?? false) ? 'checked' : '' }}
                                ...
                                <div class="space-y-3">
                                    ...
                                    <div>
                                        ...
                                        <input type="text" 
                                               ...
                                               value="{{ old("options.{$i}.translations.es", $optionTranslations->get('es')->text ?? '') }}"
                                    ...
                                    <div>
                                        ...
                                        <input type="text" 
                                               ...
                                               value="{{ old("options.{$i}.translations.en", $optionTranslations->get('en')->text ?? '') }}"
                                               class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <input type="text" 
                                               ...
                                               value="{{ old("options.{$i}.translations.fr", $optionTranslations->get('fr')->text ?? '') }}"
                                               class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                    </div>
                                </div>
                            </div>
