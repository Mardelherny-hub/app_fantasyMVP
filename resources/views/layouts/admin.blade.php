...
<head>
    ...
    <title>{{ config('app.name', 'EduCan Soccer') }} - Admin Panel</title>
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <nav class="hidden md:flex items-center space-x-2 text-sm">
                            @if(isset($breadcrumbs))
                                {{ $breadcrumbs }}
                            @else
                                <a href="{{ route('admin.dashboard', ['locale' => app()->getLocale()]) }}" class="text-gray-500 hover:text-gray-700">Dashboard</a>
                            @endif
                        </nav>
                    </div>
