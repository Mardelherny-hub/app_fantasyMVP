        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-6">
                <div class="flex items-center justify-between">
                    <div>
                        <h1 class="text-2xl font-bold text-gray-900">{{ __('Create Match') }}</h1>
            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                ...
                <form action="{{ route('admin.real-matches.store', app()->getLocale()) }}" method="POST" class="space-y-6">
                    @csrf
                    ...
                    <div>
                        ...
                        <select name="real_fixture_id" 
                            ...
                            @foreach($fixtures as $fixture)
                                <option value="{{ $fixture->id }}" {{ old('real_fixture_id') == $fixture->id ? 'selected' : '' }}>
                        ...
                        <div>
                            ...
                            <select name="status" 
                                ...
                                @foreach($statuses as $status)
                                    <option value="{{ $status }}" {{ old('status', 'finished') == $status ? 'selected' : '' }}>
