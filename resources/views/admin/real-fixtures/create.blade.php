        ...
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-6">
                <div class="flex items-center justify-between">
                    <div>
                        <h1 class="text-2xl font-bold text-gray-900">{{ __('Create Fixture') }}</h1>
            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                ...
                <form action="{{ route('admin.real-fixtures.store', app()->getLocale()) }}" method="POST" class="space-y-6">
                    @csrf
                    ...
                    <div>
                        ...
                        <select name="real_competition_id" 
                            ...
                            @foreach($competitions as $comp)
                                <option value="{{ $comp->id }}" {{ old('real_competition_id') == $comp->id ? 'selected' : '' }}>
