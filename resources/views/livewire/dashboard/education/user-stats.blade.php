        ...
        <div class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <div class="bg-white rounded-lg shadow p-6">
                    ...
                    <p class="text-3xl font-bold text-gray-800">{{ number_format($generalStats['total_score'] ?? 0) }}</p>
                </div>
                ...
                <div class="bg-white rounded-lg shadow p-6">
                    ...
                    <p class="text-3xl font-bold text-gray-800">{{ number_format($generalStats['average_score'] ?? 0, 1) }}</p>
                </div>
                ...
                <div class="bg-white rounded-lg shadow p-6">
                    ...
                    <p class="text-3xl font-bold text-gray-800">{{ number_format($generalStats['accuracy_rate'] ?? 0, 1) }}%</p>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow p-6">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div class="text-center p-4 bg-green-50 rounded-lg">
                        ...
                        <p class="text-4xl font-bold text-green-600">{{ number_format($generalStats['correct_answers'] ?? 0) }}</p>
                    </div>
                    <div class="text-center p-4 bg-red-50 rounded-lg">
                        <p class="text-sm text-gray-600 mb-1">{{ __('Wrong Answers') }}</p>
                        <p class="text-4xl font-bold text-red-600">
                            {{ number_format(($generalStats['total_answers'] ?? 0) - ($generalStats['correct_answers'] ?? 0)) }}
                        </p>
                    </div>
                </div>
            </div>
