    ...
    <div class="py-12">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <form method="POST" action="{{ route('admin.cpl.matches.store', app()->getLocale()) }}">
                        @csrf
                        ...
                        <div class="grid grid-cols-2 gap-4 mb-4">
                            <div>
                                ...
                                <input type="number" name="home_score" min="0" class="w-full rounded border-gray-300">
                                @error('home_score')
                                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                @enderror
                            </div>
                            <div>
                                ...
                                <input type="number" name="away_score" min="0" class="w-full rounded border-gray-300">
                                @error('away_score')
                                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" name="minute" min="0" max="120" class="w-full rounded border-gray-300">
                            @error('minute')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="grid grid-cols-2 gap-4 mb-4">
                            <div>
                                ...
                                <input type="datetime-local" name="started_at_utc" class="w-full rounded border-gray-300">
                            ...
                            <div>
                                ...
                                <input type="datetime-local" name="finished_at_utc" class="w-full rounded border-gray-300">
