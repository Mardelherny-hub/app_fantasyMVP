<x-admin-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">{{ __('Editar Temporada') }}</h2>
    ...
    <div class="py-6">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white p-6 rounded-xl shadow">
                <form method="POST" action="{{ route('admin.seasons.update', [app()->getLocale(), $season]) }}">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-4">
                        ...
                        <input type="date" 
                               id="starts_at" 
                               name="starts_at" 
                               value="{{ old('starts_at', $season->starts_at->format('Y-m-d')) }}"
                    ...
                    <div class="mb-4">
                        ...
                        <input type="date" 
                               id="ends_at" 
                               name="ends_at" 
                               value="{{ old('ends_at', $season->ends_at->format('Y-m-d')) }}"
