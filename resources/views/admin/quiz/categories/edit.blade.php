<x-admin-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <form action="{{ route('admin.quiz.categories.update', $category->id) }}" method="POST">
                @csrf
                @method('PUT')
                    ...
                    <div class="p-6 text-gray-900">
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text" 
                                   ...
                                   id="translations_es" 
                                   value="{{ old('translations.es', $translationsData['es'] ?? '') }}"
                                   required
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text" 
                                   ...
                                   id="translations_en" 
                                   value="{{ old('translations.en', $translationsData['en'] ?? '') }}"
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text" 
                                   ...
                                   id="translations_fr" 
                                   value="{{ old('translations.fr', $translationsData['fr'] ?? '') }}"
